...
export default {
  [LOCALES.TURKISH]: {
    ...
    welcome3: 'Daha fazlasını öğrenelim.',
    workspaceCreate1:
      'Çalışma alanı, tablolarınızı ekleyebileceğiniz veya diğer kaynaklardan içe aktarabileceğiniz projeler içerir.',
    workspaceCreate2:
      'Sizin için bir çalışma alanı ekledik ancak ihtiyacınızın artması durumunda dilediğiniz kadar çalışma alanı ekleyebilirsiniz.',
    workspaceTip1:
      'Oluşturulduktan sonra çalışma alanı adınızı ve açıklamanızı değiştirebilirsiniz.',
    workspaceTip2: 'İşleri düzenli tutmak için çalışma alanlarınıza projeler de ekleyebilirsiniz.',
    shareTip:
      'Retable, ekip arkadaşlarınızla gerçek zamanlı olarak işbirliği yapabilmeniz için çalışma alanınızı diğer kişilerle paylaşmanıza olanak tanır.',
    projectTip:
      'Bu örnek bir projedir ve bir çalışma alanında yer almaktadır. Bu projeye ortak çalışma arkadaşlarınızı eklemeyi unutmayın.',
    lastStep1: 'Hazırsınız!',
    lastStep2: 'Birlikte çalışmaya başlayalım ve güçlü iş akışları oluşturalım.',
    ...
    retableFeatureAlertMessage:
      'Retable IOS uygulaması yayında! Retable deneyiminizi güçlendirin. IOS uygulamasını hemen edinin',
    retableChromeExtText:
      "Retable deneyiminizi Android uygulamamız ile daha da iyileştirin. Şimdi Google Play'den indirin!",
    dashboardSearchInput: 'Çalışma alanlarında ve tablolarda ara',
    quickStart: 'Hızlı başlangıç rehberi',
    quickStartText: 'Retable uzmanı olmak için ihtiyacınız olan her şey',
    resources: 'Kaynaklar',
    videoTutorials: 'Video eğitimleri',
    integrations: 'Entegrasyonlar',
    discordChannel: 'Discord kanalı',
    contact: 'İletişim',
    myWorkspaces: 'Çalışma alanlarım',
    sharedWithYou: 'Seninle paylaşılan projeler',
    quicklinks: 'Hızlı linkler',
    projects: 'Projeler',
    emptyWsDescText: 'Çalışma alanınız için bir açıklama',
    emptyWsText: 'Bu çalışma alanı boş. Yeni bir proje oluşturarak başlayın',
    dashboard: 'Pano',
    news: 'Yenilikler',
    wsDetails: 'Çalışma alanı ayrıntıları',
    addOrg: 'Organizasyon ekle',
    belongToOrg: 'Bu çalışma alanı {orgName} ait',
    notBelongToOrg: 'Bu çalışma alanı herhangi bir organizasyona ait değil',
    ...
    //Retable
    noAccessWSAndPJTitle: 'Bu link erişilebilir değil',
    noAccessWSAndPJContent: 'Görüntüleme yetkiniz yok.',
    ...
    upgrade: 'Yükselt',
    upgrade2: 'YÜKSELT',
    upgradeNowProTrial: 'Şimdi yükselt',
    upgradeProtrialHeader:
      'Deneme süreniz sona erdiğinde bir plana yükseltmeniz gerekecek. Bu süre sona erdikten sonra yükseltme yapmadan dosyalarınıza  erişemeyeceksiniz.',
    proTrialRemainingTime: 'Bu çalışma alanında Pro Deneme planında {remainingTime} gün kaldı.',
    upgradeNow: 'Yükselt',
    ...
    upgradeToTeam: 'Team planına yükselt',
    ...
    subject: 'Konu',
    sendMailInfo:
      'Oluşturduğunuz otomasyon kayıtlarının içeriği gönderilmeyecektir. Yalnızca otomasyonunuzun tetiklendiğine dair bir e-posta bildirimi alacaksınız. İçerik alanına eklemek istediğiniz ek bilgiler varsa bu alandan ekleyebilirsiniz.',
    sendRecordInfo:
      'Oluşturduğunuz otomasyona uygun kayıtların içerikleri otomatik olarak gönderilecektir, içerik kısmına eklemek istediğiniz ek bilgiler varsa bu alandan ekleyebilirsiniz. ',

    //RetableAutomationModal
    NameValidation: 'Bir karakterden uzun olmalıdır.',
    selectColumn: 'Bir kolon seçin',
    invalidEmail: 'Geçersiz e-posta',
    invalidEmails: 'Geçersiz e-posta(lar)',
    upperCaseEmailError: 'Lütfen e-postayı küçük harflerle girin.',
    triggerNotcompleted: 'Lütfen bu otomasyonu etkinleştirmek için bir tetikleyici tanımlayın.',
    actionNotcompleted: 'Lütfen bu otomasyonu etkinleştirmek için bir işlem tanımlayın.',
    actionAndTriggerNotCompleted:
      'Lütfen bu otomasyonu etkinleştirmek için bir tetikleyici ve bir işlem tanımlayın.',
    ...
    addNew: 'Yeni ekle',
    noAutomationsText: 'Bu projede otomasyon yok.',
    ...
    automationCountInfo:
      'Toplamda tanımlanabilen {totalCount} otomasyondan {usedCount} tanesini kullandınız.',
    runCount: 'Otomasyon çalışma sayısı',
    automationCount: 'Otomasyon sayısı',

    //Formulation
    formulaDesc: 'Her satırda bir değer hesaplayın.',
    automationRunCountInfo:
      'Bu proje için çalıştırılan toplam otomasyon sayısı. Bu numara her ay sıfırlanır.',
    noLogDescription: 'Henüz bir kayıt oluşmadı.',
    ...
    filePreviewArea: 'Dosya önizleme alanı',
    ...
    projectTrashBinTooltip: 'Tabloları ve görünümleri geri yükle veya sil',
    ...
    removed: 'Kaldırıldı',
    noDeletedItem: 'Çöp kutunuzda hiçbir öğe yok.',
    deletedBy: 'tarafından silindi ',
    emptyTrash: 'Çöp kutusu boş',
    dashboardTrash: 'Pano çöp kutusu',
    dashboardTrashBinDesc:
      'Geri dönüşüm kutusu, silinen tüm projeleri ve çalışma alanlarını içerir.',
    projectTrashBinDesc:
      'Geri dönüşüm kutusu, projenizdeki tüm silinmiş tabloları ve görünümleri içerir.',
    user: 'Kullanıcı',
    deleted: 'Silinen',
    actions: 'Aksiyonlar',
    ...
    goToPublicToSubmit: 'Girdi göndermek için genel form görünümüne gidin',
    ...
    manageYourFiles: 'Dosyalarınızı yönetin',
    uploadYourFiles: 'Dosyalarınızı yükleyin',
    uploadText: 'Bir dosya yüklediğinizde bu projedeki tüm tablolarda mevcut olacaktır.',
    uploadNewFile: 'Yeni dosya yükle',
    filesThisCell: 'Bu hücredeki dosyalar',
    otherFiles: 'Diğer dosyalar',
    projectNoFiles: 'Bu projede dosya yok',
    cellNoFiles: 'Bu projede dosya yok',
    clickToUpload: 'Yüklemek için tıklayın',
    dragDrop: ' veya sürükleyip bırakın',
    removeFileProject: 'Bu dosya projeden kaldırılsın mı?',
    removeFileProjectText: 'Bu dosyayı kaldırdığınızda kalıcı olarak silinecek',
    removeFiles: 'Dosyaları kaldır',
    moveFiles: 'Dosyaları bu hücreye taşı',
    allFilesUploaded: 'Tüm dosyalar yüklendi',
    ...
    makeNewSubmission: 'Yeni bir gönderim yap',
    ...
    selectRetableType: 'Başka bir .retable dosyası seçin',
    ...
    importTable: 'Tabloyu içe aktar',
    importNewTable: 'Yeni bir tablo içe aktar.',
    importNewTableURL: "Bir dosya URL'sinden yeni bir tablo içe aktar.",
    ...
    yourPhotoDescription:
      'Bu fotoğraf sizinle bir çalışma alanı veya projenin paylaşıldığı yerde görüntülenecektir.',
    ...
    projectChatPlaceholder:
      'Arkadaşlarınla sohbet etmek güzeldir. Sorular sor, takımınla işbirliği yap ve değişiklikleri takip et.',
    ...
    editor: 'Editör',
    editorDesc: 'Projeleri ve tabloları düzenleyebilir ancak yapılandıramaz veya kaldıramaz.',
    owner: 'Sahip',
    ownerDesc: 'Sahiplerin çalışma alanına tam erişimi var.',
    removeUser: 'Kullanıcıyı Kaldır',
    removeUserText:
      'Bu işlem kullanıcıyı bu alandan kaldıracaktır.' +
      ' Bu işlemi gerçekleştireceğinizden emin misiniz?',
    inviteMembers: 'Paylaşım ayarları',
    publicproject: 'Genel proje',
    projLink: 'Proje bağlantısı',

    projectLinkExplanation: 'Projedeki tüm tabloları paylaşın',
    useDataExplanation: 'İzleyicilerin verileri kopyalamasına izin ver',
    projectShareOrganizationExplanation: 'Organizasyon markasını uygulayın',
    ...
    resendVerEmail: 'Doğrulama mailini tekrar gönder',
    ...
    projShared: 'Proje başarıyla paylaşıldı',
    workspaceShared: 'Çalışma alanı başarıyla paylaşıldı',

    workspaceShareSettings: '{workspaceName} çalışma alanı paylaşım ayarları',
    workspaceSharedCountInfo:
      'Bu çalışma alanı {collaboratorCount} kullanıcı ile paylaşılıyor. Paylaşılan kullanıcılar çalışma alanı altındaki bütün projelere erişebilirler.',

    projectShareSettings: '{projectName} çalışma alanı paylaşım ayarları',
    ...
    selectWSForTemplate: 'Şablonunuz için bir çalışma alanı seçin',
    selectWS: 'Çalışma alanı seç',
    selectProjectForTemplate: 'Şablonunuz için bir proje seçin',
    ...
    noEmailOrCollabCol:
      'Tablonuzda e-posta veya ortak çalışan sütunu yok. Lütfen tüm satırlara uygulanabilecek bir e-posta' +
      ' veya ortak çalışan sütunu oluşturun.',
    thisRow: 'Bu satır',
    ...
    noSnapshots: 'Yedek yok.',
    restoreTable: 'Tabloyu geri yükle',
    createTable: 'Yeni tablo oluştur',
    snapshotDescription:
      'Bir tabloyu geri yüklemek veya yeni bir tablo oluşturmak istediğinizde yedeklemenin seçilmesi gerekir.',

    // RetableSnapshotModal
    snapshots: 'Yedekler',
    takeSnapshot: 'Yedek al',
    viewPrevSnapshots:
      'Daha önce çekilmiş tüm yedekleri görüntüleyin. Bunlardan birini seçip verileri geri yükleyebilirsiniz.',
    snapShotTaken: 'Yedek alındı',
    snapShotTakenExp:
      'Projenizin yedeğini aldık. Dilediğiniz zaman yedeklere gidebilir ve bu yedeği geri yükleyebilirsiniz.',

    // RetableDataValidation
    validation: 'Doğrulama',
    validationDes: 'Hücrelere veri doğrulama kuralları koyun',
    ...
    selectRollupColumn: 'Toparlama kolonunu seçin',
    noReferencedColumn:
    ...
    addColumn: 'Başka bir kolon ekle',
    prevRecord: 'Önceki',
    nextRecord: 'Sonraki',
    addRowHistory: 'Yeni',
    watchRow: 'İzle',
    showHiddenCols: '{count} gizli kolonu göster',
    savedAutomatically: 'Otomatik olarak kaydedildi',
    ...
    searchOrAdd: 'Ara veya ekle',

    // RetableEditColumnModal
    checkProgress: 'Renkli ilerleme çubuğu kullanmak istiyorsanız bunu seçin',
    columnTypes: 'Kolon tipleri',
    ...
    dataLostText2:
      'Ancak, orijinal kolon türüne geri dönerseniz, özgün' +
    ...
    text: 'Metin',
    title: 'Başlık',
    uniqueValues: 'Her bir değer benzersiz olacaktır',
    requiredValues: 'Bu alana giriş yapılmasını zorunlu tutun',
    maskData: 'Veri maskeleme',
    maskDataDescription: 'Herkese açık olarak paylaşıldığında gerçek veriler yerine "*" gösterir',
    unique: 'Benzersiz',
    ...
    style: 'Tarz',
    max: 'Maksimum',
    emptyCellDef: 'Hücreleri varsayılan değerler ile doldurur',
    ...
    autonumberDes: 'Her kayıt için otomatik olarak benzersiz bir sayı oluşturur.',
    ...
    columnTitleMustBeUnique: 'Kolon başlığı benzersiz olmalıdır.',
    ...
    viewAsCoordinates: 'Koordinat olarak görüntüle',
    voteRules: 'Kurallar',
    ...
    prompt: 'Başlatıcı',
    voteDes: 'Tablonuzdaki satırlarda oy kullanmanıza olanak tanır.',
    currencySymbolPlacement: 'Para birimi simgesi konumu',
    percentSymbolPlacement: 'Yüzde simgesi konumu',
    left: 'Sol',
    right: 'Sağ',
    ...
    deleteAllSelected:
      'Bu işlem seçilen tüm {numberOfRows} satır(lar)ı siler. Bu işlemi gerçekleştirmek istediğinizden emin misiniz?',
    ...
    support: 'Destek',
    discord: 'Discord',
    projectsDropdownNewTabDesc: 'Yeni sekmede açmak için farenin orta düğmesini kullanın',

    // RetableTableNav
    emptyTable: 'Boş tablo',
    importRetable: 'Retable içe aktar',
    importGoogleSheet: 'Google e-tablosunu içe aktar',
    ...
    referecnedTableText: 'Bu tabloya aşağıdaki tablo(lar) referans vermektedir:',
    referecnedTableText1:
      'Lütfen önce tablo(lar)daki referansları kaldırın, ardından bu tabloyu silin.',
    ...
    unlockTableRequest: 'Kilit açma isteği',

    refDeleteTitle: 'Referansı olan bir tablo kaldırılamaz',
    ...
    //RetableFilterRow.js
    filtRowStartDate: 'Başlangıç tarihi',
    filtRowEndDate: 'Bitiş tarihi',
    filtRowNow: 'ŞİMDİ',
    noFilterCondition: 'Hiçbir filtre koşulu uygulanmadı.',
    inThisView: 'Bu görünümde kaydın nerede olduğunu gösterin',
    ...
    attachmentSizeInfoTitle: 'Disk kullanımı nasıl hesaplanır?',
    attachmentSizeInfo:
      'Toplam disk kullanımı, çalışma alanlarınızdaki ve projelerinizdeki dosyaların boyutudur. Çöp kutusundaki dosyalar da yer kaplar.',
    ...
    beforeDate: 'Tarihinden önce',
    afterDate: 'Tarihinden sonra',
    ...
    createLinkToView: 'Görüntülemek için bağlantı oluştur',
    createPublicForm: 'Genel bir form oluştur',
    createForm: 'Form oluştur',
    enableForm: 'Herkese açık formu etkinleştir',
    makeFormEditable: 'Bu formu düzenlenebilir yap',
    makeTableEditable: 'Bu tabloyu düzenlenebilir yap',
    allowViewersCopy: 'İzleyicilerin verileri kopyalamasına izni ver',
    customizeFormBranding: 'Form markalamayı özelleştirin',
    applyOrganizationBranding: 'Organizasyon markasını uygula',
    onlyLoggedInUsersViewSubmit:
      'Yalnızca oturum açmış kullanıcılar görüntüleyebilir ve gönderebilir',
    shareDataWithThisLink: 'Verilerinizi bu bağlantıyla paylaşın (gizli alanlar görünmez)',
    shareToGetSubmissions: 'Gönderim almak için bu bağlantıyı paylaşın',
    ...
    hiddenCol: 'gizli sütun',
    hiddenCols: 'gizli sütunlar',

    //retableSortMenu
    pickAnotherColumn: 'Başka bir kolon seçin',
    addAnotherSort: 'Başka bir sıralama ekle',
    ...
    deleteThisView: 'Bu görünüm silinsin mi?',
    areYouSureDeleteView: 'Bu görünümü silmek istediğinizden emin misiniz?',
    ...
    createANewProjectUnder: '{workspaceName} altında yeni bir proje yarat',

    // RetableWorkspaceListView
    emptyProject: 'Boş proje',
    sharedWith: 'ile paylaşıldı',
    ...
    invitedUserViewerRole: 'Davet edilen kullanıcı İzleyici rolüne sahip olacak.',
    ...
    viewer: 'İzleyici',
    viewerDesc: 'Bu çalışma alanı altındaki hiçbir projede düzenleme veya yorum yapamaz.',
    ...
    shareOutsideOrgTitle: 'Bu kullanıcıyı kuruluşunuza eklemek ister misiniz?',
    shareOutsideOrgMsg1: `<b>Bu kullanıcıyı kuruluşunuza eklerseniz</b> 
    kullanıcı Retable'a ücretsiz erişime sahip olacaktır. Bu, kuruluşunuzun toplam koltuk sayısından bir koltuk azalmasına neden olacaktır.`,
    shareOutsideOrgMsg2: `<b>Bu kullanıcıyı kuruluşunuza eklemeden davet ederseniz</b> kullanıcının Retable'a bireysel aboneliği olması gerekir.`,
    shareOutsideOrgMsg3: `Lütfen tercihinize göre uygun seçeneği seçin.`,
    neverShowThisAgain: 'Bunu bir daha gösterme',
    ...
    collabrativePerWorkspace: 'Çalışma alanı başına ortak çalışma',
    ...
    customContact: 'Özel iletişim',
    paymentOptions: 'Esnek ödeme seçenekleri',
    number: 'Sayı',
    checkbox: 'Onay',
    image: 'Görüntü',
    'select(options)': 'Tekli/çoklu seçim',
    ...
    proPlanTitle9: 'Yedek',
    proPlanTitle10: 'Temel, Gelişmiş ve Premium sütun türleri',
    proPlanTitle11: 'Kanban, Takvim, Kart, Harita, Izgara, Liste, Form ve Grafik Görünümü',
    proPlanTitle12: 'Çalışma alanı sayısı',
    ...
    noResultFound: 'Sonuç bulanamadı.',
    goBackTemplatesDirectory: 'Şablonlar dizinine geri dön',
    templateArchive: 'Şablon arşivi',
    useIt: 'Kullan',
    categories: 'KATEGORİLER',

    //Retable
    welcomeProj: 'İlk projene hoş geldin.',
    welcomeProjTitle: 'Bu sayfa normal bir tabloya çok benziyor, ama süper güçlere sahip.',
    welcomeProjTitle2: 'Neler yapabildiğini gösterelim.',
    step2Header: 'Bu varsayılan görünümün, normal bir tabloya benziyor.',
    step2Title:
      'Bir tablo birkaç görünümden oluşabilir ve istediğin kadar görünüm oluşturabilirsin.',
    step3:
      'İhtiyaçlarınıza ve görünüm gereksinimlerinize göre kolonları sıralayabilir, filtreleyebilir, gruplayabilir veya biçimlendirebilirsiniz.',
    step4: 'Verilerinizi hem genel hem de meslektaşlarınızla paylaşabilirsiniz.',
    step5:
      "Retable'ın proje otomasyonları, özel tetikleyici-eylem iş akışlarını doğrudan projeniz içinde yapılandırmanıza olanak tanır.",
    step6Header: 'Bu konuda harikasın!',
    step6Title:
      'İlk tablonla çalışmaya başla. İş için ne inşa ettiğini görmek için sabırsızlanıyorum!',
    ...
    snapshotStep: 'Tablonuzun yedeğini alabilirsiniz.',
    ...
    key: 'Anahtar',
    apiDesc:
      'API, Retable veritabanınıza uzaktan bağlanmak ve tablolarınıza satır eklemek veya tablolardan satır kaldırmak için kullanılabilir.',
    apiExplanation:
      'API, Retable veritabanınıza uzaktan bağlanmak ve/veya tablolarınızı kaldırmak için kullanılabilir.',
    ...
    visit: 'Ziyaret et',
    docss: 'Dokümantasyona git',
    showw: 'Göster',
    bussiness: 'İşletme',
    settingsTopbar: 'Hesap detayları',
    createNewApi: 'Yeni API anahtarı oluştur',
    deleteKeyWarning: 'Bu anahtarı silmek üzeresiniz.',
    maxAPILimit: 'Maksimum API key limiti: ',
    ...
    hideInfoMembers: 'Organizasyon bilgilerini kullanıcılara gizle',
    deleteOrganization: 'Organizasyonu sil',
    deleteOrganizationWarning: 'Bu organizasyonu sildiğinizde geri dönüş yoktur. Lütfen emin olun.',
    accountOverviewDesc:
      "Profilinizi, aboneliğinizi, ekiplerinizi, API'nizi ve günlüklerinizi yönetin",
    addUser: 'Kullanıcı ekle',
    organizationDesc:
      'Bir kuruluş eklediğinizde ekip üyelerini de ekleyebilir ve onların işbirliği yapmasına yardımcı olabilirsiniz.',
    ...
    importingData: 'Veriler içe aktarılıyor...',
    snapshotTaken: ' tarihinde yedeğiniz alındı',
    snapshotReloaded: ' yedekleme yeniden yüklendi.',
    snapReTable: ' yedekleme yeni tablo olarak yeniden yüklendi.',
    ...
    snapshotTakenSuccess: 'Yedek alındı',
    snapshotTakenSuccessDescription:
      'Projenizin yedeğini aldık. İstediğiniz zaman yedeklere gidebilir ve bu yedeği geri yükleyebilirsiniz.',
    columnAdd: 'KOLON',
    ...
    setUpd: 'Ayarlarınız başarıyla güncellendi.',
    ...
    contSs: 'Daha fazla yedek oluşturamazsınız. ',
    upgradeForSs:
      'Hesabınızı yeni bir yedekleme için yükseltin veya mevcut bir yedeğin üzerine yazın.',
    ...
    mustHaveRetableAccount: 'Kullanıcı bir Retable hesabına sahip olmalı',
    info: 'Bilgilendirme',
    ...
    ltdCanNotChangeEmail:
      'Ömür boyu anlaşmalı bir plana sahip kullanıcılar e-posta adreslerini değiştiremez.',
    ...
    fieldCannotContainUrl: '{field} URL içeremez.',
    nameCannotSpaceInName: 'İsimde boşluk olamaz.',
    dangerZone: 'Tehlikeli bölge',
    dangerZoneDesc: 'Hesabınızı bir kez sildiğinizde geri dönüş yoktur. Lütfen emin olun.',
    deleleteMyAccount: 'Hesabımı sil',
    ...
    seat: 'Alan',
    seats: 'Alanlar',
    wantToUpgrade: 'Yükseltmek ister misiniz?',
    wantToUpgradeDescription:
      "Maalesef mobil uygulama üzerinden Retable'ı satın alamazsın. Web tarayıcısı kullanarak satın alma gerçekleştirebilirsin. Bizce de garip.",
    pageNoAccessThroughApp:
      'Bu sayfaya uygulama üzerinden erişemezsiniz. Sorularınız için lütfen bizimle iletişime geçin.',
    gotIt: 'Anladım',
    ...
    // autommations
    sendMail: 'E-posta yoluyla bildirim gönder',
    ...
    sendRecords: 'Kayıtları e-postayla gönder',
    ...
    automationLastupdatedBy:
      'En son {updatedByName} tarafından {updatedInfoDate} tarihinde güncellendi.',
    automationCreatedBy: '{createdByName} tarafından {createdByDate} tarihinde oluşturuldu',
    columnTypeIsNotSupported: '{type} kolon tipi henüz desteklenmiyor.',
    ...
    snapshotHis: 'Retable, tüm değişiklikleri izlemek için yedekleme geçmişine sahiptir.',
    ...
    visualInspirations: 'Görsel ilhamlar',
    ...
    signInApple: 'Apple ile oturum açın',
    ...
    authBackgroundHeader1: 'Tüm e-tablolarınızı düzenleyin.',
    authBackgroundHeader2: 'Güvenli bir şekilde çalışın ve işbirliği içinde paylaşın.',
    authBackgroundText1:
      'Retable, e-tabloların basitliği ile veritabanlarının gücünü birleştiriyor.',
    authBackgroundText2:
      'Retable, müşteri listenizi oluşturmanızı, form oluşturmanızı, harici verileri bağlamanızı ve bilgileri görselleştirmenizi kolaylaştırır.',
    authBackgroundText4: 'Hem kolay hem de güçlü!',
    authBackgroundText3UsedBy: 'Dünya çapında',
    authBackgroundText3Customers: "2400'den fazla Müşteri",
    authBackgroundText3World: 'tarafından kullanılmaktadır.',
    ...
    canSignin: 'Şimdi oturum açabilirsiniz',
    signIn3: 'oturum açabilirsiniz.',
    alsoVerify:
      'Ayrıca tüm Retable özelliklerini kullanabilmek için e-posta adresinizi doğrulayın.',
    ...
    insertColumnBef: 'Sola ekle',
    insertColumnAft: 'Sağa ekle',
    ...
    rowBefore: 'Üste bir satır ekle',
    rowAfter: 'Alta bir satır ekle',
    ...
    // datavalidation
    minCha: 'Minimum karakter sayısı:',
    maxCha: 'Maksimum karakter sayısı:',
    regexx: 'Düzenli ifade:',
    ...
    nowYourPlanIsPro: '30 günlük Retable PRO planın tadını çıkartabilirsin!',
    ...
    successVerify: 'Başarıyla doğrulandı.',
    ...
    justImport: 'CSV, Excel veya Retable dosyasını içe aktarın',
    ...
    newProjectDesc: `Her Proje benzersiz olmalı ve tek bir temel alana odaklanmalıdır.`,
    ...
    createOrgWSDesc3: 'Yalnızca takım planıyla kullanılabilir.',
    createOrgWSDesc4:
    ...
    projectImportFileTypes: 'CSV, Excel veya Retable dosyası',
    projectDetails: 'Proje ayrıntıları',
    addNewWorkspace: 'Çalışma alanı ekle',
    clickUpload: 'Yüklemek için tıklayın',

    chooseAColor: 'Bir renk seçin',
    chooseAnIcon: 'Bir ikon seçin',
    nameReqiured: 'Ad (gerekli)',
    create: 'Oluştur',
    ...
    hideOrgForMembers: 'Üyeler için organizasyon bilgilerini gizle',
    ...
    brandTabDesc:
      "Retable'ı kendi renkleriniz, logolarınız ve simgelerinizle özelleştirebilirsiniz. Bu bölümde değişiklik yaptığınızda genel görünümler, form görünümleri, genel proje görünümleri ve Retable başlığı etkilenir.",
    ...
    deleteOrganizationMessage: 'Bir kere silindiğinde bu organizasyonu kurtaramayacaksınız!',
    orgQuantityError:
    ...
    noInvitedMembers: 'Davet edilen üye(ler) yok',
    inviteANewUser: 'Yeni bir kullanıcı davet et',
    noOrganizationInTeam:
      'Bu takımda herhangi bir organizasyon bulunmamaktadır. İlk önce yeni bir organizasyon ekleyin.',
    trialPlanFeatureMessage: 'Deneme sürümünde olduğunuz için bu özelliği kullanamazsınız.',
    freeTrialAdminInviteMessage:
      'Bir kuruluşunuz var, bu daveti kabul edip {orgName} organizasyonuna katılırsanız kendi organizasyonunuz silinecektir. Onaylıyor musun?',
    freeTrialmemberInviteMessage:
      'Zaten {orgName1} kuruluşundasınız, {orgName2} kuruluşuna geçerseniz {orgName1} kuruluşundan ayrılacaksınız. Onaylıyor musunuz?',
    ...
    // Calendar View
    chooseACalendarField: 'Bir takvim (tarih&saat) kolonu seçiniz',
    yourRowsPlacedByThisField:
      'Kayıtlarınız seçtiğiniz takvim (tarih&saat) kolonuna göre görüntülenecek.',
    yourRowsPlacedByThisRange:
      'Kayıtlarınız tarih aralığı için seçtiğiniz kolonlara göre görüntülenecek.',
    createACalendarColumn:
      'Kayıtlarınızı takvimde görüntüleyebilmek için bir takvim (tarih&saat) kolonu oluşturun.',
    createNewCalendarColumn: 'Yeni bir takvim (tarih&saat) kolonu oluştur',
    usingCalendarColumn: 'Kullanılan takvim (tarih&saat) kolonu',
    usingDateRange: 'Tarih aralığı kullanılıyor',
    //RetableMApModal.js
    locationCell: 'Konum hücresi',
    setEndDate: 'Bir bitiş tarihi alanı belirle',
    addACalendarColumn: 'Kayıtlarınız takvimdeki bu kolonda görünecektir.',

    // Map View
    chooseALocationField: 'Bir lokasyon kolonu seçiniz',
    yourRowsPlacedByThisFieldMap: 'Kayıtlarınız seçtiğiniz lokasyon kolonuna göre görüntülenecek.',
    ...
    gridViewDesc:
      'Kayıtlarınızı satırlar, alanlarınızı sütünler halinde kolayca görüntüleyin, verilerinizi görüntülemenin esnek bir yolu.',
    listViewDesc:
      'Tüm verilerinizi liste görünümünde gösterin, dikkat dağıtıcı unsurlar olmadan ve ekstra bilgilerle uğraşmadan.',
    kanbanViewDesc:
      'Tüm kayıtlarınızı kartlar halinde, bir kanban tahtasında göstermek için harika bir yol.',
    calenderViewDesc:
      'Gün, hafta ve ay seçenekleri kullanarak tüm kayıtlarınızı bir takvimde gösterin, ',
    mapViewDesc:
      'Tüm konumlarınızı görüntüleyin ve kayıtlarınızı kullanımı kolay bir dünya haritasına yerleştirin.',
    cardViewDesc:
      'Her kartın bir kaydı temsil ettiği kart görünümünü kullanarak verilerinizi görselleştirin.',
    formViewDesc:
      'Kendi formlarınızı oluşturun ve yayınlayın. Yanıtları alın ve bunları tablolarınıza kaydedin.',
    chartViewDesc: 'Kayıtlarınızı çubuk, çizgi, alan ya da pasta grafiği olarak görüntüleyin.',
    ...
    selectAFieldKanban: 'Kanban alanı',
    ...
    itemBefore: 'Öncesine bir öğe ekle',
    itemAfter: 'Sonrasına bir öğe ekle',
    addAKanbanColumn: 'Kayıtlarınız bu alana göre istiflenecektir.',

    // Formula Column
    formula: 'Formül',
    formulaColumnConfigured: 'Formul kolonları "Kolonu özelleştir" bölümden güncellenmelidir.',
    formulaListLink: 'Tüm formüllerin listesini görmek için, ',
    ...
    trialExpiredDesc:
      "Retable'a abone olun ve bilgilerini yönetmek için platform olarak Retable'ı tercih eden binlerce müşteriye katılın. Biz de sizi aramızda görmekten büyük mutluluk duyarız.",
    easyToConnect: '(ancak tekrar bağlanmak kolaydır)',
    trialArticle1: 'Çalışma alanlarınızda işbirliği yapın',
    trialArticle2: 'Sınırsız çalışma alanı ve proje',
    trialArticle3: 'Görünümler, formlar ve özel form tasarımı',
    trialArticle4: "150'den fazla şablon",
    trialArticle5: '3. parti araçlarla entegrasyonlar',
    trialArticle6: "Otomasyonlar ve webhook'lar",
    trialArticle7: 'Sınırsız tablolar',
    trialArticle8: 'Gelişmiş sütun türleri',
    trialUpgradePlan: 'Kaldığın yerden devam edebilmek için hesabını hemen yükseltebilirsin. 🌟',
    trialSendEmail: 'E-posta adresinizi doğrulayın ve muhteşem çalışmanıza devam edin!',
    trialUseCoupon:
      // eslint-disable-next-line max-len
    ...
    // Form View
    clickUpload: 'Yüklemek için tıklayın',
    orDrag: ' veya sürükleyip bırakın',
    imgFileTypes: 'JPG, PNG, GIF veya SVG dosyası',
    ...
    chooseColumns: 'Resim, qr veya renkli sütun sütununu seçin',
    ...
    cardAddImage: 'Yeni resim sütunu ekle',
    cardAddColor: 'Yeni renk sütunu ekle',
    cardAddQr: 'Yeni QR kodu sütunu ekle',
    cardAddDescription:
      'Seçtiğiniz hücre değerini kart başlığında görüntüleyebilirsiniz. Bir resim, QR veya renk sütunu ekleyin.',
    ...
    getReferenceColumnTooltip1: 'Bu kolon, {viewsJoin} tablo(ları) tarafından referans alınıyor.',
    getReferenceColumnTooltip2:
      ' Bu kolon, {viewsJoin} tablo(lar)da arama değerleri için kullanıyor.',
    getReferenceColumnTooltip3:
      '  Bu kolon, {viewsJoin} tablo(ları) için toplam kolonları tarafından kullanılıyor.',
    ...
    pleaseReadQA: 'Lütfen önce hesap silme Soru-Cevap bölümünü okuyun.',
    whatWillHappenWorkspace: 'Hesabımı silersem çalışma alanlarıma ne olacak?',
    whatWillHappenWorkspaceContent:
      "Çalışma alanınızdaki tek kullanıcı sizseniz, çalışma alanlarınız tamamiyle silinir ve bunlara bir daha erişemezsiniz. Çalışma alanlarınızda birden fazla 'Sahip' rolünde kullanıcı varsa, çalışma alanları silinmez ve workspace'i oluşturan kullanıcı ismi Account Deleted olarak görünür.",
    ...
    delErrAddPass: 'Hesabınızı silmek için öncelikle Retable parolanızı oluşturmanız gerekiyor.',
    addRetablePassword: 'Retable parolası oluştur',
    verifyYourAccount: 'Hesabınızı doğrulayın',
    deleteAccountMailSent:
      'Ek güvenlik için size bir onay e-postası gönderdik. Hesabınızı silmeden önce lütfen gelen kutunuzu kontrol edin ve şartları kabul edin. Spam/istenmeyen klasörlerinizi kontrol etmeyi unutmayın.',
    deletedAccount: 'Silinmiş Hesap',
    accDeleteOrg: 'Hesabınızı silmeden önce kuruluşunuzu silmelisiniz.',
    accConnectAdmin:
      'Yalnızca kuruluş yöneticisi sizi bu ekipten çıkarabilir. Lütfen önce kuruluş yöneticinizle bağlantı kurun.',

    //Documentation.js

    defaultRollupExampDesc:
      'Eğer Rollup sütununda bir hesaplama yapmak isterseniz, formülde (VALUES) yazmanız gerekmektedir. Ayrıca tablonuzdaki diğer sütunlarla da hesaplamalar yapabilirsiniz.',
    rollupKeywordsDesc: 'Referans alınan değerler dizisi.',

    rollupMethodInfoSumDesc: `Sayıların toplamını döndürür.`,
    rollupMethodInfoAvgDesc: 'Sayısal argümanların ortalamasını döndürür.',
    rollupMethodInfoCountDesc: 'Sayısal argümanların sayısını döndürür.',
    rollupMethodInfoMaxDesc: 'Sayısal argümanların en büyük değerini döndürür.',
    rollupMethodInfoMinDesc: 'Sayısal argümanların en küçük değerini döndürür.',

    miSumDesc: `Sayıların toplamını döndürür.`,
    miConcatenateDesc: 'Tüm metin argümanlarını birleştirir.',
    miCountdesc: 'Sayısal argümanların sayısını döndürür.',
    miCountAdesc: 'Boş olmayan argümanların sayısını döndürür.',
    miDivideDesc: 'İki sayının bölümünü hesaplar.',
    miUsDesc: 'ABD ("AA/GG/YYYY") veya ("AA/GG/YYYY SS:dd") tarih biçimi.',
    miIsoDesc: 'ISO ("YYYY-AA-GG") veya ISO ("YYYY-AA-GG SS:dd") tarih biçimi.',
    miEuDesc: 'Avrupa ("GG/AA/YYYY") veya ("GG/AA/YYYY SS:dd") tarih biçimi.',
    miTrueDesc: 'Mantıksal değer doğru.',
    miFalseDesc: 'Mantıksal değer yanlış.',
    miAverageDesc: 'Sayısal argümanların ortalamasını döndürür.',
    miMaxDesc: 'Sayısal argümanların en büyük değerini döndürür.',
    miMinDesc: 'Sayısal argümanların en küçük değerini döndürür.',
    miTodayDesc:
      'Biçimlendirilmiş geçerli tarihi metin olarak döndürür. (Varsayılan tarih biçimi EU() ("GG/AA/YYYY").)',
    miNowDesc: `Biçimlendirilmiş geçerli tarihi ve saati metin olarak döndürür. (Varsayılan tarih biçimi EU("zaman") ("GG/AA/YYYY SS:dd").)`,
    miDaysDesc:
      'İki tarih arasındaki gün sayısını döndürür. (Varsayılan tarih biçimi EU() ("GG/AA/YYYY").)',
    miDateFormatDesc:
      "Tarihi biçimlendirir. Giriş parametresi 'tarih_metin' geçerli bir formatta olmalıdır. 'geçerli_biçim' verilen tarih_metin'in formatıdır. Varsayılan 'hedef_biçim' EU'dur. Varsayılan yerel format 'en'dir. Diğer desteklenen yerel formatlar arasında 'es', 'tr', 'de' ve 'fr' bulunur.",
    miAddDaysdesc: 'Bir tarihe gün ekler.',
    miWorkDaysDesc: 'İki tarih arasındaki iş günü sayısını döndürür.',
    miCompleteDesc:
      'Geçerli bitirme yüzdesini hesaplar, bitiş tarihi ve başlangıç tarihi argümanlarına göre.',
    miProggressDesc:
      'Geçerli sayısal argüman ve hedef sayısal argümana göre tamamlanma yüzdesini hesaplar.',
    miToNumberDesc: 'Argümanı sayıya dönüştürür.',
    miToTextDesc: 'Argümanı metne dönüştürür.',
    miLenDesc: 'Metnin uzunluğunu döndürür.',
    miIfDesc:
      'Mantıksal ifade DOĞRU ise "değer_eğer_doğru" değerini, DEĞİLSE "değer_eğer_yanlış" değerini döndürür.',
    miIsBeforeDesc:
      'Tarih_1 tarih_2\'den önceyse 1 döndürür, aksi halde 0 döndürür. (Varsayılan tarih biçimi EU() ("GG/AA/YYYY").)',
    miIsAfterDesc:
      'Tarih_1 tarih_2\'den sonraysa 1 döndürür, aksi halde 0 döndürür. (Varsayılan tarih biçimi EU() ("GG/AA/YYYY").)',
    miIsSameDesc:
      'İki tarihi birimine kadar karşılaştırır ve aynıysa 1 döndürür, aksi halde 0 döndürür. Desteklenen birimler "yıl", "ay", "gün", "saat" ve "dakika"\'dır. (Varsayılan tarih biçimi EU())',
    miIsBetween:
      'Hedef_tarih start_tarih ve end_tarih arasındaysa 1 döndürür, aksi halde 0 döndürür.',
    miDurationsDesc:
      'İki tarih arasındaki süreyi hesaplar ve verilen biçim kullanılarak insanlaştırılmış metin olarak döndürür. Desteklenen çıkış biçimi birimleri "yıl", "ay", "gün", "saat", "dakika" ve "saniye"\'dir. (Varsayılan tarih biçimi EU(), varsayılan çıkış biçimi "yıl,ay,gün,saat,dakika,saniye")',

    //Saga.js socket.emit header and message parts
    deleteColumnMessage: 'Kolon(lar) silindi.',
    deleteColumnHeader: 'Kolon',

    updateStyleHeader: 'Tablo stili',
    updateStyleMessageTrue: 'Tablo stili güncellendi',
    updateStyleMessageFalse: 'Tablo stili uygulandı',

    sortDataHeader: 'Sırala',
    sortDataMessage: 'Sıralama uygulandı',

    updateFilterHeader: 'Filtre',
    updateFilterMessage: 'Filtre uygulandı',

    updateFormOptionsHeader: 'Form',
    updateFormOptionsMessage: 'Form özelleştirildi',

    updateGroupByHeader: 'Grup',
    updateGroupByMessage: 'Gruplama uygulandı',

    formRowUpdateHeader: 'Güncelle',
    formRowUpdateMessage: 'Satır verileri güncellendi',

    submitFormHeader: 'Satır',
    submitFormMessage: 'Form gönderimi sonrasında yeni satır eklendi',

    updateDataHeader: 'Güncelle',
    updateDataMessage: 'Veriler güncellendi',

    deleteDataHeader: 'Sil',
    deleteDataMessage: 'Veriler silindi',

    updateColumnHeader: 'Kolon',
    updateColumnMessage: 'Kolonlar güncellendi',

    insertColumnHeader: 'Kolon',
    insertColumnMessage: 'Kolon(lar) eklendi',

    moveColumnHeader: 'Kolon',
    moveColumnMessage: 'Kolon taşındı',

    updateTableWithTableIDHeader1: 'Filtre',
    updateTableWithTableIDHeader2: 'Kolon',
    updateTableWithTableIDMessage1: 'Filtre uygulandı.',
    updateTableWithTableIDMessage2: 'Kolon(lar) güncellendi.',

    updateDataAndColumnsHeader: 'Kolon',
    updateDataAndColumnsMessage: 'Kolon kopyalandı',

    updateTableWithTableIDPasteHeader: 'Yapıştır',
    updateTableWithTableIDPasteMessage: 'Veriler yapıştırıldı',

    updateTableWithTableIDImportHeader: 'İçe aktar',
    updateTableWithTableIDImportMessage: 'Veriler içe aktarıldı',

    delimiteColumnHeader: 'Sınırlandır',
    delimiteColumnMessage: 'Kolon sınırlandırıldı',

    moveRowHeader: 'Satır',
    moveRowMessage: 'Satır taşındı',

    updateViewShareHeader: 'Paylaş',
    updateViewShareMessage: 'Görünüm paylaşımı güncellendi',

    newRowHeader: 'Veri',
    newRowMessage: 'Veri eklendi',

    updateAutomationHeader: 'OTOMASYON',
    updateAutomationMessage: 'Otomasyon oluşturuldu',
    updateAutomationUpdatedMessage: 'Otomasyon güncellendi',
    updateAutomationDeletedMessage: 'Otomasyon silindi',
    updateAutomationStatusMessage: 'Otomasyon durumu güncellendi',

    updateChartHeader: 'Güncelle',
    updateChartMessage: 'Grafik görünümü güncellendi',

    updateViewPayloadHeader: 'Güncelle',
    updateViewPayloadMessage: 'Takvim görünümü güncellendi',
    updateViewPayloadKanbanMessage: 'Kanban görünümü güncellendi',
    updateViewPayloadCardMessage: 'Kart görünümü güncellendi',
    updateViewPayloadMapMessage: 'Harita görünümü güncellendi',

    resizeColumnHeader: 'Kolon',
    resizeColumnMessage: 'Kolon boyutu değiştirildi',

    hideColumnHeader: 'Kolon',
    hideColumnMessage1: 'bir kolon gizlendi',
    hideColumnMessage2: 'bir kolon görünür hale getirildi',

    goToProject: 'Projeye git',
    copyMovePaymentError:
      'Projedeki satır limitin doldu. Projeye gidip eğer yoksa Satır Limit eklentisini satın alabilirsiniz, eğer eklenti varsa limitinizi aşmadığınıza emin olun.',
    maxFileImportTitle: 'Bu dosya eklemek için çok büyük',
    maxFileImportText:
      'Dosya {limit} boyutundan büyük olduğu için eklenemiyor. Lütfen daha küçük dosyalar kullanın.',

    // RetableAddonView
    addonNotFound: 'Eklentiler bulunamadı.',
    addons: 'Eklentiler',
    extendMore: 'Daha fazla ekle',
    subscribed: 'Abone olundu',
    buyNow: 'Satın alın',
    mo: 'ay',
    addonModalSubtitle: 'Tablolarınızı güçlendirmek için bir eklenti seçin.',
    addonNeedOrgTitle: 'Organizasyon gerekli',
    addonTeamPlan: 'Eklentiler yalnızca Team planlarında mevcuttur.',
    addonNeedOrg: 'Eklenti satın alabilmeniz için organizasyon oluşturmanız gerekli.',
    addonInDevelopment: 'Bu eklenti geliştirilme aşamasındadır. Sabrınız için teşekkürler.',
    addonContactAdmin:
      'Sadece organizasyon yöneticileri eklentiler için satın alma yapabilir, lütfen organizasyon yöneticinizle iletişime geçin.',
    addonPer: 'Her bir {path} için',
    oneTimePer: 'Tek sefer {path}',
    smWorkspace: 'çalışma alanı',
    smProject: 'proje',
    addonWillActiveFor: 'Bu eklenti bulunduğunuz {path} için aktif olacaktır.',
    goAddonPage: 'Beni eklenti sayfasına götür',
    available: 'Mevcut',
    finished: 'Bitti',
    upcoming: 'Yaklaşan',
    unavailable: 'Kullanım dışı',
    planRenewAt: 'Planınız {path} tarihinde yenilenecektir.',
    planCancelAt: 'Planınız {path} tarihinde iptal edilecektir.',
    quantity: 'Adet',
    promotion: 'Promosyon',
    installed: 'İndirildi',
    install: 'İndir',
    promotionUsedFor: 'Bu eklenti promosyonu {path1} {path2} için kullanılmıştır.',
    promoTier4: 'Appsumo Tier4',
    activateFree: 'Ücretsiz kullanmaya başlamak için etkinleştir',
    goToAppsumo: "Appsumo'ya git",
    addonNeedTier4:
      "Promosyon eklentileri yalnızca Tier 4 için kullanılabilir. Promosyon eklentilere erişim sağlamak için Tier 4'e yükseltme yapmanız gerekiyor.",
    afterCancellation: 'İptal ettikten sonra tekrar kurabilirsiniz.',
    renew: 'Yenile',
    increaseRowLimitTitle: 'Satır limitinizi artırın?',
    increaseRowLimitText:
      "Her proje için {limit} satır limitiniz var. 'Satır Limit' eklentisini satın alarak limitinizi 100.000 satıra çıkarabilirsiniz.",
    maxRowLimitTitle: 'Maksimum satır limitine ulaştınız',
    maxRowLimitText:
      'Her proje için maksimum {limit} satır limitine ulaştınız. Verilerinizin bu limiti aşmadığından emin olun.',
    increaseFileUploadLimitTitle: 'Bu dosya, tablonuza eklemek için fazla büyük',
    increaseFileUploadLimitText:
      "Dosyaları {limit}’den fazla ekleyemezsiniz. Bu sınırı artırmak için 'Yükleme Sınırı' eklentisini satın alın.",
    maxFileUploadLimitTitle: 'Bu dosya, tablonuza eklemek için fazla büyük',
    maxFileUploadLimitText:
      'Dosyaları {limit}’den fazla ekleyemezsiniz. Lütfen daha küçük dosyalar kullanın.',
    increaseStorageLimitTitle: 'Bu dosyayı yüklemek için yeterli alanınız yok',
    increaseStorageLimitText:
      "Çalışma alanınızda {limit} sınırınız var. Biraz yer açmak için bazı dosyaları kaldırın veya 'Depolama Sınırı' eklentisini satın alın.",
    maxStorageLimitTitle: 'Biraz temizlik zamanı!',
    maxStorageLimitText:
      'Çalışma alanınızda {limit} sınırınız var. Lütfen daha fazla alan açmak için bazı dosyaları temizleyin.',
    increaseAutomationCountTitle: 'Otomasyon hakkınız doldu',
    increaseAutomationCountText:
      "Şu anda {count} aktif otomasyon sayısı sınırınız var. Otomasyon sayısını artırmak için lütfen 'Otomasyon Sayısı' eklentisini satın alın.",
    maxAutomationCountTitle: 'Maksimum {count} otomasyon hakkınız doldu',
    maxAutomationCountText:
      'Daha fazla otomasyon ekleyemezsiniz. Lütfen daha fazla eklemek için bazı otomasyonları silin.',
    addonTwoMonthFree: '2 ay ücretsiz',
    perMonth: 'her ay',
    run: 'çalıştır',
    trialUserCannotPurchaseAddon:
      'Ücretsiz deneme durumundaki kullanıcılar eklentileri satın alamazlar.',
    tempUserCannotPurchaseAddon: 'Geçici kullanıcılar eklentileri satın alamazlar.',

    // Addons
    ADDON_PASSWORD_PROTECTION_name: 'URL erişim koruması',
    ADDON_PASSWORD_PROTECTION_description:
      'Projelerinize, görünümlerinize veya formlarınıza şifre koruma mekanizması eklemek istiyorsanız URL erişim koruması eklentisi size yardımcı olacaktır. Bu şekilde herkese açık projeleriniz, görünümleriniz ve formlarınız için şifreler belirleyebilirsiniz. Bu nedenle kullanıcıların parola korumalı projelerinizi, görünümlerinizi veya formlarınızı görmek için bir parola girmeleri gerekecektir. Uygulandıktan sonra bu eklenti, içinde bulunduğunuz proje için geçerli olacaktır.',
    ADDON_STORAGE_LIMIT_name: 'Depolama Sınırı',
    ADDON_STORAGE_LIMIT_description:
      'Eğer daha fazla depolama alanı eklemek istiyorsanız, ek depolama alanı sınırı eklentisi tam size göre. Bir Depolama Sınırı eklentisi satın almak, ek dosya ekleme alanınızı 10 GB artırır. En fazla 9 Depolama Limiti eklentisi satın alabilirsiniz. Her eklentiyi bir çalışma alanında kullanabileceksiniz.',
    ADDON_UPLOAD_LIMIT_name: 'Yükleme sınırı',
    ADDON_UPLOAD_LIMIT_description:
      'Dosyaları bölmek veya sınırlara takılmak artık sorun olmayacak! Yükleme Sınırı eklentisi, dosya yükleme sınırınızı 10 MB artırır. En fazla 4 Yükleme Sınırı eklentisi satın alabilirsiniz. Her eklentiyi bir iş alanında kullanabileceksiniz.',
    ADDON_ADDITIONAL_ROWS_name: 'Satır sınırı',
    ADDON_ADDITIONAL_ROWS_description:
      "Her bir projeniz için 50,000 satır sınırlamanız bulunmaktadır. Satır Sınırı eklentisi, bir projenizin satır sınırlamasını 100,000'e çıkartmanıza yardımcı olur. Kurulduğunda, seçtiğiniz projede kullanıma hazır olacaktır.",
    ADDON_AUTOMATION_RUN_COUNT_name: 'Otomasyon çalıştırma sayısı',
    ADDON_AUTOMATION_RUN_COUNT_description:
      'Daha fazla otomasyon çalıştırma sayısı eklemek istiyorsanız, Otomasyon Çalıştırma Sayısı eklentisi tam size göre. Bu eklenti, aktif otomasyon sayınızı +25000 artırır. En fazla 5 Otomasyon Çalıştırma Sayısı eklentisi satın alabilirsiniz. Her eklentiyi bir projede kullanabileceksiniz.',
    ADDON_AUTOMATION_COUNT_name: 'Otomasyon sayısı',
    ADDON_AUTOMATION_COUNT_description:
      'Daha fazla otomasyon eklemek istiyorsanız, Otomasyon Sayısı eklentisi tam size göre. Bu eklenti, aktif otomasyon sayınızı +10 artırır. En fazla 9 Otomasyon Sayısı eklentisi satın alabilirsiniz. Her eklentiyi bir projede kullanabileceksiniz.',
    PROMO_ROW_SIZE_50_name: 'Satır sınırı',
    PROMO_ROW_SIZE_50_description:
      "Her bir projeniz için 50,000 satır sınırlamanız bulunmaktadır. Satır Sınırı eklentisi, bir projenizin satır sınırlamasını 100,000'e çıkartmanıza yardımcı olur. Kurulduğunda, seçtiğiniz projede kullanıma hazır olacaktır.",
    PROMO_STORAGE_LIMIT_20_name: 'Depolama sınırı 20GB',
    PROMO_STORAGE_LIMIT_20_description:
      'Depolama sınırı eklentisi, seçtiğiniz çalışma alanı için ek dosya depolama alanı 20 GB artacaktır.',
    PROMO_AUTOMATION_COUNT_20_name: 'Otomasyon sayısı',
    PROMO_AUTOMATION_COUNT_20_description:
      'Otomasyon sayısı eklentisi, bu projeyi ekstra 20 otomasyon ile güçlendirir.',
    PROMO_AUTOMATION_RUN_COUNT_125_name: 'Otomasyon çalıştırma sayısı',
    PROMO_AUTOMATION_RUN_COUNT_125_description:
      'Otomasyon çalıştırma sayısı eklentisi, bu projeyi ekstra 125,000 otomasyon çalıştırma ile güçlendirir.',
    //Account Overview
    ...
    wsCreatedBy: 'Bu çalışma alanı şu kişi tarafından oluşturulmuştur: ',
    rename: 'Yeniden isimlendir',

    // RetableSuggestionPopup
    suggestionText:
      'Verilerinizi güçlendirmek için temel sütun türlerinin nasıl kullanılacağını gösteren videomuzu izleyin.',
    checkboxText: 'Bunu tekrar gösterme',
  },
};
